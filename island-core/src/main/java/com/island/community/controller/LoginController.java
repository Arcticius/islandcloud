...
import com.island.community.client.AdminClient;
...
//    private AdminstraterService adminstraterService;
    ...
    public String register(Model model, User user){
        ...
        Map<String,Object> map = userClient.register(user);
    ...
    public String registerAsAdminstrater(Model model, Administrator administrator, @RequestParam("adminstraterCode") String adminstraterCode){
        System.out.println("code is " +adminstraterCode);
        System.out.println("get username "+ administrator.getUsername());
        Map<String,Object> map = adminClient.registerAsAdminstrater(administrator,adminstraterCode);
        if(map==null||map.isEmpty())
        {
    ...
    public String activation(Model model, @PathVariable("userId") int userId,@PathVariable("code") String code){
        ...
        int result=userClient.activation(userId,code);
    ...
    public String login(String username,String password,String code,
        ...
        Map<String,Object> map=userClient.login(username,password,expiredSeconds);
